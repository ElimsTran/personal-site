...
export default function SpotifyPlaylist(props: SportifyPlaylistProps) {
  return (
    <Box className="max-w-[350px] opacity-50 fixed top-[3%] right-0 translate-x-[calc(100%)] border-[1px] [&:hover]:translate-x-0 [&:hover]:opacity-100 transition ease-in-out duration-500 z-50 delay-200">
