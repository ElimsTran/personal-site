    ...
    <Container component={"main"} maxWidth="md" className="flex flex-col p-0 ">
      <Box className="flex flex-col items-center justify-center align-middle gap-2 select-none min-h-[88vh] ">
        ...
        <Box className="flex flex-col justify-center items-center gap-5">
          <Box className="w-[150px] h-[150px] rounded-[50%] flex items-center justify-center overflow-hidden shadow-sm reveal-animation bg-[url('/pixelRoom.jpg')] bg-fixed bg-contain">
            <Image
              src={"/avt_hi.webp"}
              alt="avt"
              loading={"eager"}
